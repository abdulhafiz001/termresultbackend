...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Tenant connection (DB-per-school). The database name is set at runtime by IdentifyTenant middleware.
        'tenant' => [
            'driver' => env('TENANT_DB_DRIVER', env('DB_CONNECTION', 'mysql')),
            'url' => env('TENANT_DB_URL', env('DB_URL')),
            'host' => env('TENANT_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('TENANT_DB_PORT', env('DB_PORT', '3306')),
            'database' => env('TENANT_DB_DATABASE', ''), // overwritten at runtime
